<template>
  <Layout activePath="/inventoryOperation">
    ...
    <div class="select-wrapper">
      <el-autocomplete class="myAutocomplete" v-model="selected_product" :fetch-suggestions="querySearch"
        placeholder="请选择商品" @select="handleSelect" :popper-append-to-body="false">
    ...
    <product-info-card v-if="cur_product" class="info-card" :card_type="card_type" :product_info="cur_product"
      @handleSubmit="handleSubmit"></product-info-card>
  </Layout>
</template>
